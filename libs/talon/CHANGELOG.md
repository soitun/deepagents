...
## [0.0.9](https://github.com/soitun/deepagents/compare/deepagents-talon==0.0.8...deepagents-talon==0.0.9) (2026-09-26)
...
* **talon:** add `send_message` for progress updates ([#6264](https://github.com/soitun/deepagents/issues/6264)) ([15606d2](https://github.com/soitun/deepagents/commit/15606d280a8ddb86c8966fef0bab257f8070944f))
...
* **talon:** add configurable conversation history storage ([#6115](https://github.com/soitun/deepagents/issues/6115)) ([99fcef8](https://github.com/soitun/deepagents/commit/99fcef85410736e211f5b0bcb2e9f1651e685105))
* **talon:** add configuration hardening self-review skill ([#6136](https://github.com/soitun/deepagents/issues/6136)) ([e760662](https://github.com/soitun/deepagents/commit/e760662c956c581a0aca2cd4c95a3a7ce2cbd187))
...
* **talon:** add optional hybrid conversation history search ([#6108](https://github.com/soitun/deepagents/issues/6108)) ([904326a](https://github.com/soitun/deepagents/commit/904326a7932f72a189fcf0a74ba1f77a4087f79f))
* **talon:** add targeted conversation deletion ([#6235](https://github.com/soitun/deepagents/issues/6235)) ([4fb301d](https://github.com/soitun/deepagents/commit/4fb301d647c860d0d8f2108149e58cd9fe623352))
...
* **talon:** batch concurrent tool approvals ([#6435](https://github.com/soitun/deepagents/issues/6435)) ([1660147](https://github.com/soitun/deepagents/commit/16601472424400ab4a90608d7d95e8fc61f23267))
...
* **talon:** manage tool approvals through `tools.json` ([#6248](https://github.com/soitun/deepagents/issues/6248)) ([a273ad6](https://github.com/soitun/deepagents/commit/a273ad6c6a595c3aff915b744750711b50d544e3))
...
* **talon:** register chat commands as Discord slash commands ([#6303](https://github.com/soitun/deepagents/issues/6303)) ([f36b641](https://github.com/soitun/deepagents/commit/f36b641ce3e1f44dbd47835d6dc9f5bb1c82324a))
...
* **talon:** run a scheduled job's subagents inline ([#6425](https://github.com/soitun/deepagents/issues/6425)) ([c3a041e](https://github.com/soitun/deepagents/commit/c3a041e3d8f593e4e4c9bfc273d52264ceff165b))
...
* **talon:** ship defensive research defaults ([#6131](https://github.com/soitun/deepagents/issues/6131)) ([1a835d2](https://github.com/soitun/deepagents/commit/1a835d216260d3b140af528d42fbb75eca26f818))
...
* **talon:** support fresh subagents and per-task tool selection ([#6129](https://github.com/soitun/deepagents/issues/6129)) ([276a385](https://github.com/soitun/deepagents/commit/276a385d6c49ef63f0cae107e5a1afa591191e03))
...
* **talon:** backfill missing research subagent defaults ([#6135](https://github.com/soitun/deepagents/issues/6135)) ([54cf354](https://github.com/soitun/deepagents/commit/54cf354d04d094eaf77c17ed239fdd235e4ebc83))
* **talon:** bound archive scans, query embeddings, and deletion markers ([#6162](https://github.com/soitun/deepagents/issues/6162)) ([79c23e6](https://github.com/soitun/deepagents/commit/79c23e669bf81cddf16e4ab1582ccc9b26d8bea7))
* **talon:** bound the vector rebuild, break the import cycle, pin postgres ([#6165](https://github.com/soitun/deepagents/issues/6165)) ([8462c24](https://github.com/soitun/deepagents/commit/8462c24524541f49a3eb53037580110586973c8c))
* **talon:** close a url swap past the MCP auto-approve guard ([#6173](https://github.com/soitun/deepagents/issues/6173)) ([d886742](https://github.com/soitun/deepagents/commit/d8867426af3ab83c31d64a11e5b84a21ce86a43d))
* **talon:** correct history embedding token budget and prompt defaults ([#6132](https://github.com/soitun/deepagents/issues/6132)) ([caabca2](https://github.com/soitun/deepagents/commit/caabca2b479ec731a81fa42e4c53c9471895fd7b))
* **talon:** declare the packages talon imports directly ([#6436](https://github.com/soitun/deepagents/issues/6436)) ([c63eba4](https://github.com/soitun/deepagents/commit/c63eba426b28f1d1685e40767f087dcc3f34334c))
* **talon:** deliver background subagents launched by a scheduled job ([#6228](https://github.com/soitun/deepagents/issues/6228)) ([b6dc5c5](https://github.com/soitun/deepagents/commit/b6dc5c5a8c6c1124f8e243868a83b9af188b08c7))
...
* **talon:** fix local voice transcription and embedding retries ([#6255](https://github.com/soitun/deepagents/issues/6255)) ([a97ba32](https://github.com/soitun/deepagents/commit/a97ba320fa797e9546efe3486ce703e8efd30fb4))
* **talon:** harden the MCP OAuth device flow and credential paths ([#6170](https://github.com/soitun/deepagents/issues/6170)) ([e6c5829](https://github.com/soitun/deepagents/commit/e6c58294d6792bcf433eb5f38fec1b5be70cc065))
...
* **talon:** index only visible conversation text ([#6358](https://github.com/soitun/deepagents/issues/6358)) ([f6850e9](https://github.com/soitun/deepagents/commit/f6850e9d25854b5679010c08f02adae99e6b8a2c))
* **talon:** keep results a discarded turn never reported ([#6231](https://github.com/soitun/deepagents/issues/6231)) ([481773c](https://github.com/soitun/deepagents/commit/481773caed336c86034e1c72b4988e7e93968610))
...
* **talon:** make background subagents and host start/stop recoverable ([#6166](https://github.com/soitun/deepagents/issues/6166)) ([d4c41b0](https://github.com/soitun/deepagents/commit/d4c41b048132eb27e2337b60b21463403b615390))
* **talon:** make MCP configuration updates bounded and non-destructive ([#6171](https://github.com/soitun/deepagents/issues/6171)) ([f995931](https://github.com/soitun/deepagents/commit/f9959311bfeb788191f971fe32552b01adbac199))
* **talon:** make remote embedding settings explicit and search non-blocking ([#6133](https://github.com/soitun/deepagents/issues/6133)) ([3698f10](https://github.com/soitun/deepagents/commit/3698f10bc46ef6ac6d7b30c1fcdc499a8ac08b28))
* **talon:** make subagent orchestration state what it enforces ([#6167](https://github.com/soitun/deepagents/issues/6167)) ([05620cc](https://github.com/soitun/deepagents/commit/05620cc72bfa7b81ce41064641cfa5808cb7c74a))
...
* **talon:** persist history vector deduplication ([#6357](https://github.com/soitun/deepagents/issues/6357)) ([b3d4967](https://github.com/soitun/deepagents/commit/b3d4967bdcda5b42e976b3e97c357deea82d63ac))
* **talon:** persist local model downloads ([#6137](https://github.com/soitun/deepagents/issues/6137)) ([fc91199](https://github.com/soitun/deepagents/commit/fc91199a44b99990cca49341169aea858da222fc))
...
* **talon:** report Discord gateway failures after startup ([#6113](https://github.com/soitun/deepagents/issues/6113)) ([94e4520](https://github.com/soitun/deepagents/commit/94e452077cf2650b0a410da7fa1e23b28d5dd8e1))
* **talon:** report MCP protocol errors to the model ([#6239](https://github.com/soitun/deepagents/issues/6239)) ([edd0bcf](https://github.com/soitun/deepagents/commit/edd0bcfc61dc16eabea0b3a59aa84569e3b240dc))
...
* **talon:** retry statusless provider overload errors ([#6304](https://github.com/soitun/deepagents/issues/6304)) ([f8acbd0](https://github.com/soitun/deepagents/commit/f8acbd0ae24278d35aeb1fa014056084a58f70d2))
...
* **talon:** share one optional-driver loader and close provider clients ([#6164](https://github.com/soitun/deepagents/issues/6164)) ([02cea21](https://github.com/soitun/deepagents/commit/02cea210d7f3e5bc2bf89453e8a6e4af59031f59))
* **talon:** stop HistoryEmbeddings defaulting to Qwen's query prefix ([#6134](https://github.com/soitun/deepagents/issues/6134)) ([933d863](https://github.com/soitun/deepagents/commit/933d86350f0d0ffa54359d4f00510e52ccdc2b85))
* **talon:** stop losing MCP refresh tokens on a refresh response ([#6172](https://github.com/soitun/deepagents/issues/6172)) ([7dc07cb](https://github.com/soitun/deepagents/commit/7dc07cbb60f144e2b7fc266ee452b06c8b8dd10c))
* **talon:** stop one conversation from stalling or outliving the rest ([#6168](https://github.com/soitun/deepagents/issues/6168)) ([134ffc7](https://github.com/soitun/deepagents/commit/134ffc7bb4eba504ee90aaae3a70df87c6ea3217))
* **talon:** store offloaded artifacts in the assistant home ([#6530](https://github.com/soitun/deepagents/issues/6530)) ([74d768b](https://github.com/soitun/deepagents/commit/74d768bd45dd4eca977dc320ebfe5838f1691682))
* **talon:** surface indexing failures and bound the indexing worker ([#6163](https://github.com/soitun/deepagents/issues/6163)) ([03653d6](https://github.com/soitun/deepagents/commit/03653d6d95ceb0b1b6739998fd9475e304489d12))
* **talon:** treat trailing [SILENT] as a suppression marker ([#6110](https://github.com/soitun/deepagents/issues/6110)) ([92576da](https://github.com/soitun/deepagents/commit/92576daf1cfaadfc811445b29be9457a78eb4e5e))
* **talon:** unwind the channel that fails mid-start, and keep teardown safe ([#6169](https://github.com/soitun/deepagents/issues/6169)) ([5406820](https://github.com/soitun/deepagents/commit/5406820ec1c00ce521b0f54bb786c511da092f01))
* **talon:** validate archive pagination arguments ([#6442](https://github.com/soitun/deepagents/issues/6442)) ([f84d963](https://github.com/soitun/deepagents/commit/f84d96358a111872fba3f9b69c5b08ad1565c083))


### Performance Improvements

* **talon:** reduce archive replay transactions ([#6320](https://github.com/soitun/deepagents/issues/6320)) ([89bd48f](https://github.com/soitun/deepagents/commit/89bd48f7d531c9affafa3f0dc096083cbc5969dd))
